    ...
    <>
      <nav className="navbar navbar-expand-lg">
        <div className="container">
          ...
          <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarup" aria-expanded="false" aria-label="Toggle navigation">
