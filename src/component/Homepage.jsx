...
function Home() {
  return (
    <>
      <div className='hero'>
        <div className="container text-light text-center  pt-4">
          <h1 className='pt-5' style={{marginTop:'60px'}}>Easy & Quick Cargo Shipping Services </h1>
          <p style={{fontSize:'20px'}}>Book low cost sea freight shipping services. Get an instant quote.</p>
      ...
      <div className="container pt-5">
        <div className="text-center" data-aos="fade-up">
          ...
          <p className='pt-3'> Crystal Shipment is more than logistics. We can also optimize your packaging, manage your material sourcing and so much more. </p>
        </div>
      </div>
      <div className="row">
            ...
            <div className="d-flex mt-3">
              ...
              <div className="d-flex mt-3">
                ...
                <div className="flex-grow-1 ms-2">
                  ...
                  <p>We offer intelligent concepts for road and rail as well as complex special transport services</p>
                </div>
              ...
              <div className="d-flex mt-3">
                ...
                <div className="flex-grow-1 ms-2">
                  <h4>Careful Hhandling of Valuable Goods.</h4>
